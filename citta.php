...
<html>
    ...
    <body>
        <div class="grid-container-citta">
            <div class="navcont">
                <nav id="navbar">
                    <ul>
                        ...
                        <li id="nav2">Welcome to <em><?php echo $_SESSION['cittaUtente']; ?></em></li>
                        <li id="nav3"> 
                            <div class="dropdown">
            ...
            <div class="fotoMid" style="background-image:url(images/<?php echo $_SESSION['cittaUtente']; ?>.jpg)">  
                <h1 id="titlehome"><em><?php echo $_SESSION['cittaUtente']; ?> </em></h1>
